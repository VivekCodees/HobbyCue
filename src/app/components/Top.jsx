...
const Top = () => {
    ...
    return (
        <div className={`fixed bottom-20 right-[1vw]  flex flex-col items-center gap-3 ${isVisible ? 'visible' : 'hidden'}`}>
            <div onClick={scrollToTop} className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center drop-shadow-2xl cursor-pointer text-[#939CA3] hover:text-black hover:bg-[#aa7979]" aria-label="Scroll to top">
            ...
            <div className='text-[14px] leading-[16px] font-semibold text-[#212121] p-3 lg:block hidden'>Go to top</div>
        </div>
    );
};
