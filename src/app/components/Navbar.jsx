    ...
    return (
        <div className='px-[7vw] py-4 flex items-center justify-between bg-white drop-shadow-lg fixed w-full z-10'>
            ...
            <div className='flex items-center gap-6'>
                ...
                {/* Sign In Button */}
                <button className='text-[14px] text-[#8064A2] hover:text-white hover:bg-[#8064A2] duration-300 leading-[16px] font-semibold border-[1px] border-[#8064A2] rounded-lg px-8 py-3 lg:block hidden'>Sign In</button>
            </div>
        </div>
    );
}
