                    ...
                    <div key={index} className='group' onMouseEnter={() => setHoverColors(prevState => prevState.map((val, idx) => idx === index ? true : val))}
                        ...
                        <div className={`border border-[#CED4DA] rounded-lg lg:px-11 px-6 lg:py-10 py-5 sm:w-[40vw] bg-white duration-300 h-full`}
                            ...
                            <div className='flex items-center gap-6'>
                                ...
                                <div className='font-semibold text-[16px] lg:text-[24px] group-hover:text-white'>{value.name}</div>
                            </div>
                            <div className='font-light text-[12px] lg:text-[18px] mt-6 mb-8 group-hover:text-white'>{value.content}</div>
                            <button className='font-semibold text-[10px] lg:text-[14px] leading-[16px] text-[#8064A2] group-hover:text-white border-2 border-[#8064A2] group-hover:border-white duration-700 rounded-lg text-center py-2 px-5 lg:py-3 lg:px-8'>{value.btnName}</button>
                        </div>
                    </div>
                ))}
            </div>
