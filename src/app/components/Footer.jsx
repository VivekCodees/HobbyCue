        ...
        <div>
            <div className='px-[7vw] py-[60px] flex sm:flex-row flex-col gap-8 lg:flex-nowrap flex-wrap justify-between'>
                ...
                <div className='text-[14px] leading-[18px] tracking-wide'>
                    ...
                    <div className="flex flex-col gap-2 mt-4 text-[10px] lg:text-[14px] cursor-pointer">
                        <div>About Us</div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-[10px] lg:gap-5 mt-4">
                    ...
                    <div className='mt-[50px]'>
                        ...
                        <div className='text-[12px] leading-[16px] flex'>
                            <input type="email" placeholder='Email ID' className='text-[#939CA3] rounded-l-lg px-4 py-3 border-[1px] border-[#8064A2] w-[85%]' />
                            <button className='bg-[#8064A2] text-white tracking-wide font-semibold w-[20%] py-3 border-[1px] border-[#8064A2] rounded-r-lg'>Invite</button>
                        </div>
                    </div>
                </div>
            </div>
